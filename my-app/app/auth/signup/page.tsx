          ...
          <div className="w-full max-w-md">
            ...
            <div className="bg-[#ecf0ff] p-1 rounded-lg mb-8">
              <div className="flex">
                ...
                <Link href="/auth/signin" className="flex-1 bg-[#ecf0ff] rounded-lg">
                  <Component2 text="Sign In" active="No" />
                </Link>
              </div>
            </div>
            ...
            <p className="text-center text-[#9c9aa5] text-xs leading-normal">
              ...
              <span className="text-[#26203b] font-medium">Terms of use & Privacy Policy.</span>
            </p>
          </div>
        </div>
      </div>
