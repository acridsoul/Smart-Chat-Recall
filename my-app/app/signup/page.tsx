        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-12">
            ...
            <p className="font-manrope font-extralight text-gray-300 text-[24px] leading-[32px]">
              Join thousands organizing their AI conversations
            </p>
          </div>
          ...
          <div className="bg-black border border-gray-800 rounded-lg p-8">
            ...
            <form className="space-y-4">
              <div>
                <label htmlFor="fullName" className="block text-sm font-roboto text-gray-300 mb-2">
                  Full Name
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="confirmPassword" className="block text-sm font-roboto text-gray-300 mb-2">
                  Confirm Password
                </label>
                <input
                  type="password"
              ...
              <div className="flex items-start space-x-3 mb-6">
                <input
                  ...
                  id="terms"
                  name="terms"
                  className="mt-1 h-4 w-4 text-blue-600 border-gray-700 rounded focus:ring-blue-500 bg-gray-900"
                />
                <label htmlFor="terms" className="text-sm font-roboto text-gray-300">
                  I agree to the{" "}
